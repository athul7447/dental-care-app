              ...
              <div class="card-body">
                  <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        ...
                        <input type="number" class="form-control" id="appointment_per_day" name="appointment_per_day" value="{{ $doctor->appointment_per_day }}" placeholder="Count of appointments per day">
