            ...
            <td width="600" valign="top" align="center" style="border-collapse:collapse;">
              <table align="center" border="0" cellpadding="0" cellspacing="0" style="background: #F9FAFB;" width="100%">
                ...
                <a style="color: #3498DB; text-decoration: none;" href="https://www.getrevue.co/profile/brightonsmith?utm_campaign=Subscription+confirmation&amp;utm_content=profile-image&amp;utm_medium=email&amp;utm_source=confirmation" target="_blank">
                    <img style="width: 56px; height: 56px; border: 0;" alt="tooth fairies" src="{{  asset('admin_assets/img/favicon/fav_icon.png')}}">
                </a></td>
                </tr>
                <tr>
                <td align="left" style="padding: 0 56px 5px 56px;" valign="top">
                <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333; font-weight: bold;">Hi {{ ucfirst($mailData['name']) }},</div>
                </td>
                </tr>
                <tr>
                ...
                <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 18px; color: #333;">
                    Thank you for your appointment request. We have received your request and will get back to you shortly.
                </div>
                </td>
                </tr>
                <tr>
                <td align="center" bgcolor="#F9FAFB" style="padding: 28px 56px;" valign="top">
                <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; color: #666666; font-weight: 900;">Get in touch with us</div>
                <div style="font-family: &quot;lato&quot;, &quot;Helvetica Neue&quot;, Helvetica, Arial, sans-serif; line-height: 28px;font-size: 16px; color: #000;">
                <a style="color: #55ACEE;     text-decoration: auto;"  target="_blank" href="{{ route('customer.index') }}">www.toothfairies.com</a>
                </div>
                </td>
                </tr>
                </tbody></table>
