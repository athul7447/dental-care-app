...
@section('content')
<div class="site-blocks-cover inner-page" style="background-image: url({{asset('user_assets/images/hero_bg_2.jpg')}});" data-aos="fade" data-stellar-background-ratio="0.5">
    <div class="container">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 pr-md-5 text-left mb-5">
          <div>
            <img src="{{asset('user_assets/images/person_1.jpg')}}" alt="Image" class="w-50 mb-5 rounded-circle">
            <h3>Dr. Emily Sy</h3>
        ...
        <div class="col-md-6 pl-md-5 text-left">
          <div>
            <img src="{{asset('user_assets/images/person_3.jpg')}}" alt="Image" class="w-50 mb-5 rounded-circle">
