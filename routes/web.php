...
Route::get('doctor-availability.html',[\App\Http\Controllers\Customer\CustomerController::class,'doctorAvailability'])->name('customer.doctor-availability');
...
Route::prefix('portal')->name('portal.')->group(function () {
    ...
    Route::get('/patient-database',[\App\Http\Controllers\Doctor\DoctorContoller::class,'patientNotes'])->name('patient.notes');
    Route::get('/patient-database/get-note',[\App\Http\Controllers\Doctor\DoctorContoller::class,'getNote'])->name('patient.note.get');
    Route::post('patient-database/store',[\App\Http\Controllers\Doctor\DoctorContoller::class,'storePatientNote'])->name('patient.note.store');
});
